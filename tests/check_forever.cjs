...
assert.deepStrictEqual(files, ['WoWSyncCompat.lua', 'WoWSyncForever.lua', 'WoWSyncCore.lua',
    'WoWSyncForeverCollectors.lua', 'WoWSyncForeverBags.lua', 'WoWSyncForeverProfessions.lua', 'WoWSyncForeverSpells.lua', 'WoWSyncForeverBank.lua', 'WoWSyncForeverTrainers.lua', 'WoWSyncRender.lua', 'WoWSyncUI.lua'], 'Forever observer load order');
